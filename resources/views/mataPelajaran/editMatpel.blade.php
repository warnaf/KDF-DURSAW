          ...
          <div class="card-body">
            ...
            <form class="mt-4" method="post" action="/matpel/{{ $id }}">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control @error('is_penjuruan') is-invalid @enderror" name="is_penjuruan" id="is_penjuruan" placeholder="isi penjuruan atau jenjang" required value="{{ old('is_penjuruan',  $is_penjuruan) }}">
                  @error('is_penjuruan')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
